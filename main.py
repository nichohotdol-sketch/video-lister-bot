...
# Evita erro no Render caso o módulo imghdr não exista
try:
    import imghdr
...
REPLIT_URL = os.environ.get("REPLIT_URL", "https://video-lister-bot--nichohotdol.replit.app/")  # atenção à barra final
